...
#include "HostUIWidget.h"
#include "Runtime/Engine/Classes/Engine/UserInterfaceSettings.h"
#include "Runtime/Engine/Classes/Engine/RendererSettings.h"
#include <Blueprint/WidgetLayoutLibrary.h>
#include <Components/CanvasPanelSlot.h>

void UHostUIWidget::NativeConstruct() {
...
void UHostUIWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime) {
...
void UHostUIWidget::SetHostState(HostUIState newState) {
	CurrentState = newState;
}

void UHostUIWidget::GetMouseToWidgetOffset(float& offsetLeft, float& offsetTop, float& offsetRight, float& offsetBottom) {
	float mouseX, mouseY;
...
void UHostUIWidget::StartObjGeneration() {
	if (selectionImg) {
...
void UHostUIWidget::EndObjGeneration() {
	if (selectionImg) {
...
void UHostUIWidget::OnGenerateObjectMode() {
	if (selectionImg) {
		UCanvasPanelSlot* slot = UWidgetLayoutLibrary::SlotAsCanvasSlot(selectionImg);
		if (slot) {
